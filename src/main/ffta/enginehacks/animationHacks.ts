...
const weaponAnimationPointers = characterWeaponAnimationPointers + 4;
const animationsTable = characterWeaponAnimationPointers + 288;
...
export function firstPass(fftaData: FFTAData) {
  ...
  const newWeapon0Pointer = 0x08000000 + animationsTable;
  // Offsets 0,2,4
  ...
  let newWeapon1 = buildAnimation([
    {
      offset: parseInt(soldierFrames[21][0], 16),
      oam: soldierFrames[21][1] as number,
      duration: 0x6,
      unknown: 0x1,
      short1: 0x0,
      short2: 0x0,
    ...
    {
      offset: parseInt(soldierFrames[27][0], 16),
      oam: soldierFrames[27][1] as number,
      duration: 0x14,
      unknown: 0x1,
      short1: 0x0,
      short2: 0x1,
    ...
    {
      offset: parseInt(soldierFrames[23][0], 16),
      oam: soldierFrames[23][1] as number,
      duration: 0x1,
      unknown: 0x1,
      short1: 0x0,
      short2: 0x0,
    ...
    {
      offset: parseInt(soldierFrames[28][0], 16),
      oam: soldierFrames[28][1] as number,
      duration: 0x2,
      unknown: 0x1,
      short1: 0x0,
      short2: 0xfffc,
    ...
    {
      offset: parseInt(soldierFrames[29][0], 16),
      oam: soldierFrames[29][1] as number,
      duration: 0x17,
      unknown: 0x1,
      short1: 0x0,
      short2: 0xfffc,
    ...
    {
      offset: parseInt(soldierFrames[9][0], 16),
      oam: soldierFrames[9][1] as number,
      duration: 0x8,
      unknown: 0x1,
      short1: 0x0,
      short2: 0x0,
  ...
  let newWeapon2 = buildAnimation([
    ...
    {
      offset: parseInt(soldierFrames[7][0], 16),
      oam: soldierFrames[7][1] as number,
      duration: 0x4,
      unknown: 0x1,
      short1: 0x0,
      short2: 0x2,
  ...
  let newWeapon3 = buildAnimation([
    ...
    {
      offset: parseInt(soldierFrames[10][0], 16),
      oam: soldierFrames[10][1] as number,
      duration: 0x4,
      unknown: 0x1,
      short1: 0x0,
      short2: 0x2,
  ...
  const animationBlock = FFTAUtils.joinUint8Array([
    FFTAUtils.getWordUint8Array(0x08000000 + weaponAnimationPointers, true),
  ...
  fftaData.rom.set(animationBlock, characterWeaponAnimationPointers);
