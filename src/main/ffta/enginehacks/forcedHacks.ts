...
export function injectAnimationFixes(rom: Uint8Array) {
  ...
  // Advice, Wyrmtamer, Parley
  rom.set([0xec, 0x22], 0xf496a);
  // Wyrmtamer, Parley
  rom.set([0xec, 0x21], 0x100592);
  // Morpher Idle
  rom.set([0xed, 0x25], 0x9764c);
  // Stunts, Conceal part 1
  rom.set([0xee, 0x21], 0x101500);
  rom.set([0xee, 0x21], 0x102724);
  rom.set([0xee, 0x21], 0x103078);
  // Saint Cross, Tremor, Lancet, Far fist
  rom.set([0xef, 0x22], 0xf4f26);
  rom.set([0xef, 0x22], 0xf595a);
  rom.set([0xef, 0x22], 0xfa6aa);
  rom.set([0xef, 0x24], 0xf7c34);
  // Conceal part 2
  rom.set([0xf0, 0x21], 0x1030b6);
  // Whirlwind, Mow Down, Wild Swing, Swallowtail
  rom.set([0xf1, 0x22], 0xf621e);
  rom.set([0xf1, 0x22], 0xf6ae8);
  rom.set([0xf1, 0x22], 0xf87b0);
  rom.set([0xf1, 0x22], 0xfc1fc);
  // Throw, Hurl
  rom.set([0xf2, 0x21], 0xfe4a8);
  rom.set([0xf2, 0x22], 0x1027de);
  // Bangaa Cry, Breaths, Warcry
  rom.set([0xf3, 0x22], 0xfae7a);
  rom.set([0xf3, 0x26], 0x1087c4);
  rom.set([0xf3, 0x22], 0xf9228);
  // Summon, Spirit Magic
  rom.set([0xf4, 0x21], 0xe0f36);
  // Ninjutsu
  rom.set([0xf5, 0x21], 0xe140e);
  // Revive, Exorcise, Holy Sign
  rom.set([0xf6, 0x21], 0xe0f4e);
  // Provoke
  rom.set([0xf7, 0x22], 0xf3616);
  // Jump Takeoff
  rom.set([0xf8, 0x21], 0xf9cb2);
  // Jump Land
  rom.set([0xf9, 0x22], 0xf9f2e);
